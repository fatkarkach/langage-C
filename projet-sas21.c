           ...
           printf("\n\t\t 1)Retrait\t\n");
            ...
            if (re != -1)
            {
                ...
                printf("\n\tt_cin[%d]=%s",re,t_cin[re]);
                    ...
                    scanf("%f",&nouv_montant[re]);
                    if(t_montant[re]>=nouv_montant[re])
                    {
                        t_montant[re]= t_montant[re]-nouv_montant[re];
                        printf("\n\tNouveau montant %f : \n",t_montant[re]);
                    }
                    else
                    {
...
printf("\n\t\t 4)affichage Descendant(les comptes bancaires ayant un montant superieur à un chiffre introduit)\n");
       ...
       switch(choix)
       {
           case 1:trierA(t_montant);
           break;
           case 2:trierD(t_montant);
           break;
            case 3:chiff_trierA( t_montant);
           break;
            case 4:chiff_trierD( t_montant);
           break;
